...
-- Node 5 (Node 12 (Node 1 (Node 96 Nil Nil) Nil) (Node 0 Nil Nil)) (Node 4 (Node 2 Nil Nil) (Node 5 Nil (Node 21 Nil Nil)))



charBTree :: BTree Char
charBTree = Node 'k' Nil Nil
...
sumTree Nil = 0
sumTree (Node value left right) = (sumTree left) + (sumTree right) + value
